...
public class LevelMakerEditor : EditorWindow
{
    ...
    string[] toolbarStrings = new string[] { "Editor", "Settings", "Shop", "In-apps", "Ads", "GUI" };
    ...
    [MenuItem("Window/Jelly Garder editor")]
    static void Init()
    {
    ...
    void OnFocus()
    {
        ...
        if (EditorApplication.currentScene == "Assets/JellyGarden/Scenes/game.unity")
        {
    ...
    void OnGUI()
    {
        ...
        if (oldSelected != selected) scrollViewVector = Vector2.zero;
    ...
    void GUIAds()
    {
        ...
        initscript.enableAds = EditorGUILayout.Toggle("Enable ads", initscript.enableAds, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
        GUILayout.Space(10);
       
        initscript.unityAdsID = EditorGUILayout.TextField("Unity Ads id", initscript.unityAdsID, new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(200) });
        GUILayout.Space(10);
        initscript.rewardedVideoZone = EditorGUILayout.TextField("Rewarded video zone id", initscript.rewardedVideoZone, new GUILayoutOption[] { GUILayout.Width(300), GUILayout.MaxWidth(300) });
        initscript.nonRewardedVideoZone = EditorGUILayout.TextField("Non-Rewarded video zone id", initscript.nonRewardedVideoZone, new GUILayoutOption[] { GUILayout.Width(300), GUILayout.MaxWidth(300) });
        GUILayout.Space(10);
        GUILayout.BeginHorizontal();
        initscript.ShowChartboostAdsEveryLevel = EditorGUILayout.IntField("Show Chartboost ads every ", initscript.ShowChartboostAdsEveryLevel, new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) });
        GUILayout.Label(" level (0 = disable)", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width(150) });
        GUILayout.EndHorizontal();
        GUILayout.Space(10);
        GUILayout.BeginHorizontal();
        initscript.admobUID = EditorGUILayout.TextField("Admob Interstitial ID ", initscript.admobUID, new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) });
        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal();
        initscript.ShowAdmobAdsEveryLevel = EditorGUILayout.IntField("Show Admob ads every ", initscript.ShowAdmobAdsEveryLevel, new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) });
        GUILayout.Label(" level (0 = disable)", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width(150) });
        GUILayout.EndHorizontal();

        if (initscript.ShowChartboostAdsEveryLevel < 0) initscript.ShowChartboostAdsEveryLevel = 1;
        if (initscript.ShowAdmobAdsEveryLevel < 0) initscript.ShowAdmobAdsEveryLevel = 0;
        GUILayout.Space(10);
    ...
    void GUIInappSettings()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            lm.InAppIDs[i] = EditorGUILayout.TextField("Product id " + (i + 1), lm.InAppIDs[i], new GUILayoutOption[] { GUILayout.Width(300), GUILayout.MaxWidth(300) });
        ...
        lm.GoogleLicenseKey = EditorGUILayout.TextField("Google license key", lm.GoogleLicenseKey, new GUILayoutOption[] { GUILayout.Width(300), GUILayout.MaxWidth(300) });
    ...
    void GUISettings()
    {
        ...
        lm.FacebookDisable = EditorGUILayout.Toggle("Disable Facebook", lm.FacebookDisable, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
        GUILayout.Space(10);
        ...
        if (score_settings)
        {
            ...
            GUILayout.Space(30);
            GUILayout.BeginVertical();
            lm.scoreForItem = EditorGUILayout.IntField("Score for item", lm.scoreForItem, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            lm.scoreForBlock = EditorGUILayout.IntField("Score for block", lm.scoreForBlock, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            lm.scoreForWireBlock = EditorGUILayout.IntField("Score for wire block", lm.scoreForWireBlock, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            lm.scoreForSolidBlock = EditorGUILayout.IntField("Score for solid block", lm.scoreForSolidBlock, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            lm.scoreForThrivingBlock = EditorGUILayout.IntField("Score for thriving block", lm.scoreForThrivingBlock, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            GUILayout.Space(10);

            lm.showPopupScores = EditorGUILayout.Toggle("Show popup scores", lm.showPopupScores, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
            GUILayout.Space(10);

            lm.scoresColors[0] = EditorGUILayout.ColorField("Score color item 1", lm.scoresColors[0], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColors[1] = EditorGUILayout.ColorField("Score color item 2", lm.scoresColors[1], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColors[2] = EditorGUILayout.ColorField("Score color item 3", lm.scoresColors[2], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColors[3] = EditorGUILayout.ColorField("Score color item 4", lm.scoresColors[3], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColors[4] = EditorGUILayout.ColorField("Score color item 5", lm.scoresColors[4], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColors[5] = EditorGUILayout.ColorField("Score color item 6", lm.scoresColors[5], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            GUILayout.Space(10);

            lm.scoresColorsOutline[0] = EditorGUILayout.ColorField("Score color outline item 1", lm.scoresColorsOutline[0], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColorsOutline[1] = EditorGUILayout.ColorField("Score color outline item 2", lm.scoresColorsOutline[1], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColorsOutline[2] = EditorGUILayout.ColorField("Score color outline item 3", lm.scoresColorsOutline[2], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColorsOutline[3] = EditorGUILayout.ColorField("Score color outline item 4", lm.scoresColorsOutline[3], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColorsOutline[4] = EditorGUILayout.ColorField("Score color outline item 5", lm.scoresColorsOutline[4], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.scoresColorsOutline[5] = EditorGUILayout.ColorField("Score color outline item 6", lm.scoresColorsOutline[5], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        }
        GUILayout.Space(20);
        ...
        if (life_settings_show)
        {
            ...
            initscript.CapOfLife = EditorGUILayout.IntField("Max of lifes", initscript.CapOfLife, new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            GUILayout.Space(10);
            ...
            lm.lifeShop.CostIfRefill = EditorGUILayout.IntField("Cost of refilling lifes", lm.lifeShop.CostIfRefill, new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        }
        GUILayout.Space(20);
        ...
        if (failed_settings_show)
        {
            ...
            lm.FailedCost = EditorGUILayout.IntField(new GUIContent("Cost of continue", "Cost of continue after failed"), lm.FailedCost, new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.ExtraFailedMoves = EditorGUILayout.IntField(new GUIContent("Extra moves", "Extra moves after continue"), lm.ExtraFailedMoves, new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            lm.ExtraFailedSecs = EditorGUILayout.IntField(new GUIContent("Extra seconds", "Extra seconds after continue"), lm.ExtraFailedSecs, new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        if (target_description_show)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                lm.targetDiscriptions[i] = EditorGUILayout.TextField("", lm.targetDiscriptions[i], new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) });
    ...
    void GUIShops()
    {
        ...
        if (gems_shop_show)
        {
            ...
            foreach (GemProduct item in lm.gemsProducts)
            {
                ...
                GUILayout.BeginHorizontal();
                GUILayout.Space(30);
                item.count = EditorGUILayout.IntField("", item.count, new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(100) });
                item.price = EditorGUILayout.FloatField("", item.price, new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(100) });
                GUILayout.EndHorizontal();
                GUILayout.EndVertical();
                GUILayout.EndHorizontal();
                i++;
        ...
        if (boost_show)
        {
            ...
            foreach (BoostProduct item in bp)
            {
                ...
                item.description = EditorGUILayout.TextField("", item.description, new GUILayoutOption[] { GUILayout.Width(400), GUILayout.MaxWidth(400) });
                GUILayout.EndHorizontal();
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    item.count[i] = EditorGUILayout.IntField("", item.count[i], new GUILayoutOption[] { GUILayout.Width(80), GUILayout.MaxWidth(80) });
                    item.GemPrices[i] = EditorGUILayout.IntField("", item.GemPrices[i], new GUILayoutOption[] { GUILayout.Width(80), GUILayout.MaxWidth(80) });
                    GUILayout.EndHorizontal();
    ...
    void GUILevelSelector()
    {
        ...
        try
        {
            ...
            {
                if (LoadDataFromLocal(int.Parse(changeLvl))) levelNumber = int.Parse(changeLvl);
    ...
    void GUILevelSize()
    {
        ...
        maxRows = EditorGUILayout.IntField("Rows", maxRows, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
        maxCols = EditorGUILayout.IntField("Columns", maxCols, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) });
        if (maxRows < 3) maxRows = 3;
        if (maxCols < 3) maxCols = 3;
        if (maxRows > 11) maxRows = 11;
    ...
    void GUILimit()
    {
        ...
        if (limitTypeSave != limitType || oldLimit != limit) SaveLevel();
    ...
    void GUIColorLimit()
    {
        ...
        if (colorLimit < 3) colorLimit = 3;
        if (colorLimit > 6) colorLimit = 6;

        GUILayout.EndHorizontal();

        if (saveInt != colorLimit)
        {
            if ((int)collectItems[0] > colorLimit + 2) collectItems[0] = (CollectItems)(int)(CollectItems.Item1) + 0;
            if ((int)collectItems[1] > colorLimit + 2) collectItems[1] = (CollectItems)(int)(CollectItems.Item1) + 1;
            SaveLevel();
        }
    ...
    void GUITarget()
    {
        ...
        if (target == Target.COLLECT)
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                if ((int)collectItems[i] > colorLimit) collectItems[i] = (CollectItems)(int)(CollectItems.Item1) + i;
                if ((int)collectItems[i] > 0)
                    ingrCount[i] = EditorGUILayout.IntField("", ingrCount[i], new GUILayoutOption[] { GUILayout.Width(100) });
                else
                    ingrCount[i] = 0;
                GUILayout.EndHorizontal();
                if (oldIngr != collectItems[i]) SaveLevel();
                if (oldCount != ingrCount[i]) SaveLevel();
            }
        }
        else if (target == Target.INGREDIENT)
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                if (i == 0 && ingr[i] == Ingredients.Ingredient2) ingr[i] = Ingredients.Ingredient1;
                else if (i == 1 && ingr[i] == Ingredients.Ingredient1) ingr[i] = Ingredients.Ingredient2;
                if ((int)ingr[i] > 0)
                    ingrCount[i] = EditorGUILayout.IntField("", ingrCount[i], new GUILayoutOption[] { GUILayout.Width(100) });
                else
                    ingrCount[i] = 0;
                GUILayout.EndHorizontal();
                if (oldIngr != ingr[i]) SaveLevel();
                if (oldCount != ingrCount[i]) SaveLevel();
            }
        }
        GUILayout.EndVertical();
    ...
    {
        levelNumber++;
        if (!LoadDataFromLocal(levelNumber)) levelNumber--;
    }
