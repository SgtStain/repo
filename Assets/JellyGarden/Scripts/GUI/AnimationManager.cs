...
public class AnimationManager : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        {
            if (!InitScript.Instance.enableAds || !Advertisement.IsReady()) transform.Find("Image/Video").gameObject.SetActive(false);
        }
    ...
    void Update()
    {
        ...
        {
            if (name == "MenuPlay" || name == "Settings" || name == "BoostInfo" || name == "GemsShop" || name == "LiveShop" || name == "BoostShop" || name == "Reward") CloseMenu();
        }
    }
...
//            InitScript.Instance.currentTarget = InitScript.Instance.targets[PlayerPrefs.GetInt( "OpenLevel" )];
        ...
        if (name == "PreFailed")
        {
            if (LevelManager.THIS.Limit <= 0) LevelManager.THIS.gameStatus = GameState.GameOver;
            transform.Find("Video").gameObject.SetActive(false);
        ...
        if (name.Contains("gratzWord")) gameObject.SetActive(false);
        if (name == "NoMoreMatches") gameObject.SetActive(false);
        if (name == "CompleteLabel") gameObject.SetActive(false);
    ...
    public void WaitForGiveUp()
    {
        if (name == "PreFailed")
        {
            ...
            if (InitScript.Instance.enableAds)
            {
...
//        CloseMenu();
    ...
    public void Buy( GameObject pack )
    {
        ...
        if( pack.name == "Pack1" )
        {
            ...
            return;
#endif
            INAPP.Instance.purchaseProduct(LevelManager.THIS.InAppIDs[0]);
        }
        ...
        if( pack.name == "Pack2" )
        {
            ...
            return;
#endif
            INAPP.Instance.purchaseProduct(LevelManager.THIS.InAppIDs[1]);
        }
        if( pack.name == "Pack3" )
        {
            InitScript.waitedPurchaseGems = int.Parse( pack.transform.Find( "Count" ).GetComponent<Text>().text.Replace( "x ", "" ) );
            ...
            return;
#endif
            INAPP.Instance.purchaseProduct(LevelManager.THIS.InAppIDs[2]);
        }
        if( pack.name == "Pack4" )
        {
            InitScript.waitedPurchaseGems = int.Parse( pack.transform.Find( "Count" ).GetComponent<Text>().text.Replace( "x ", "" ) );
            ...
            return;
#endif
            INAPP.Instance.purchaseProduct(LevelManager.THIS.InAppIDs[3]);
        }
        CloseMenu();
